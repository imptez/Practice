...
public class InputFileRecord {
    ...
    @CsvBindByName(column = "PAYMENT_TOKEN", required = false)
    ...
    public InputFileRecord(String id, String customerId, String cardBrand,
                           String lastDigits, String paymentToken,String expiryDate) {
        this.id = id;
